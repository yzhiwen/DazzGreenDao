...
import ${entity.classPackagePath};
</#list>
 ...
 */
public class ${schema.schemaName}DaoSession extends AbstractDaoSession {
...
<#list schema.entities as entity>
    ...
    public ${schema.schemaName}DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
            daoConfigMap) {
        super(db);
